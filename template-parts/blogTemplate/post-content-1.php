<?php global $wp_query;
 ?>
<?php $skip_min_height = false; ?><section class="u-clearfix u-section-1" id="sec-6466">
    ...
    <div class="u-blog u-expanded-width u-repeater u-repeater-1"><!--blog_post-->
      <?php while (have_posts()) : the_post(); $postItemInvisible = !has_post_thumbnail() ? true : false; ?><div class="u-blog-post u-container-style u-repeater-item u-white u-repeater-item-1">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--blog_post_header-->
          ...
          <a href="<?php the_permalink(); ?>" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-1"><?php _e(sprintf(__('Read more', 'site5'))); ?></a><!--/blog_post_readmore-->
        </div>
